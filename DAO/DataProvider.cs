...
namespace DAO
{
    public class DataProvider
    {
        ...
        // You can change your database connection here 
        private string connectionString = @"Data Source=LAS_Chanh\LASCHANH;Initial Catalog=TestingDB;User ID=hoangthanh;Password=123";
