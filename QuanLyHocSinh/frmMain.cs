    ...
    public partial class frmMain : Office2007RibbonForm
    {
        ...
        private static async Task CapNhatPhanMem()
        {
            ...
            using (var manager = await UpdateManager.GitHubUpdateManager(url))
            {
                ...
                {
                    MessageBox.Show(
                    "A new update is available. Please restart the software!",
"Update to new version",
        ...
        private void btnDangNhap_Click(object sender, EventArgs e)
        {
            while (true)
            {
                ...
                if (string.IsNullOrWhiteSpace(username))
                {
                    ...
                    frmLogin.lblUserError.Text = "You have not entered a username!";
                    continue;
                }
                ...
                if (string.IsNullOrWhiteSpace(password))
                {
                    ...
                    frmLogin.lblPassError.Text = "You have not entered a password!";
                    continue;
                }
                ...
                {
                    frmLogin.lblUserError.Text = "Incorrect information!";
                    frmLogin.lblPassError.Text = "Incorrect information!";
                    continue;
                }
            }
        }
        ...
        private void btnDangXuat_Click(object sender, EventArgs e)
        {
            ...
            lblTenNguoiDung.Text = "Do not have";
        ...
        private void btnDoiMatKhau_Click(object sender, EventArgs e)
        {
            while (true)
            {
                ...
                {
                    frmChangePass.lblOldPassError.Text = "No current password entered!";
                ...
                if (string.IsNullOrWhiteSpace(newPassword))
                {
                    ...
                    frmChangePass.lblNewPassError.Text = "No new password entered!";
                    frmChangePass.lblConfirmPassError.Text = "";
                    continue;
                }
                ...
                if (string.IsNullOrWhiteSpace(confirmPassword))
                {
                    frmChangePass.lblOldPassError.Text = "";
                    frmChangePass.lblNewPassError.Text = "";
                    frmChangePass.lblConfirmPassError.Text = "Password confirmation not entered!";
                    continue;
                }

                if (password != oldPassword)
                {
                    frmChangePass.lblOldPassError.Text = "Incorrect old password entered!";
                    frmChangePass.lblNewPassError.Text = "";
                    frmChangePass.lblConfirmPassError.Text = "";
                    continue;
                }
                else if (newPassword != confirmPassword)
                {
                    frmChangePass.lblOldPassError.Text = "";
                    frmChangePass.lblNewPassError.Text = "";
                    frmChangePass.lblConfirmPassError.Text = "The confirmation entered does not match!";
                    continue;
                }
                else
                {
        ...
        private void btnSaoLuu_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Data backup successful!", "BACKUP COMPLETED", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void btnPhucHoi_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Data recovery successful!", "RESTORE COMPLETED", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        public void ShowGiaoDienHocSinh()
        {
            //True
            btnDangXuat.Enabled = true;
            btnDangXuatContext.Enabled = true;
